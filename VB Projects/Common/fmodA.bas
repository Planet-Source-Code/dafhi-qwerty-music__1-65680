...
'    Name(4)         As Byte         ' The string "TOC" (4th character is 0), just in case this structure is accidentally treated as a string.
    Name         As Long         ' The string "TOC" (4th character is 0), just in case this structure is accidentally treated as a string.
    NumTracks       As Long         ' The number of tracks on the CD.
    min(100)        As Long         ' The start offset of each track in minutes.
    Sec(100)        As Long         ' The start offset of each track in seconds.
    Frame(100)      As Long         ' The start offset of each track in frames.
End Type
